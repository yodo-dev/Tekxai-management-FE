...
const EmployeeTimesheet: React.FC = () => {
    ...
    const columns: Column<TimesheetEntry>[] = [
        ...
        //             <button className="p-1.5 hover:bg-gray-50 text-gray-400 hover:text-gray-600 rounded-md transition-all active:scale-95">
                ...
                <Card className="flex flex-col gap-4 shadow-xl border-none p-0 overflow-hidden bg-white">
                    ...
                    <div className="px-4 pb-4">
                        <Table
                            ...
                            headerClassName="bg-[#F0F5FF]/50 border-none rounded-md"
                        />
                    </div>
                </Card>
            ) : (
                /* My Requests View */
                <div className="flex flex-col gap-8 bg-white p-6 rounded-md">
                    {/* Sub Header */}
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="mt-4">
                            ...
                            {isLoadingRequests ? (
                                ...
                                <Card key={req.id} className="p-6 flex flex-col gap-4 mt-4 bg-white border border-gray-100 shadow-sm">
                                    ...
                                    <Badge
                                        variant="info"
                                        className={cn(
                                            "!w-max px-2 py-0.5 text-[10px] font-bold rounded-md border",
                            ...
                            )) : <p className="text-xs text-gray-400  mt-2">No edit requests found.</p>}
                        </div>
                    </div>
                </div>
            )}
