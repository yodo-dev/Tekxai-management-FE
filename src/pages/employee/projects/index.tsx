...
const EmployeeProjects: React.FC = () => {
  ...
  const columns: Column<ProjectSummary>[] = [
      ...
      render: (item) => (
        <div className="flex -space-x-2">
          {item.members.map((m, i) => (
            <div key={i} className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 border-2 border-white flex items-center justify-center text-[10px] font-bold text-white  ring-1 ring-blue-50">
              {m}
            </div>
          ))}
    ...
    },
    {
      ...
      render: (item) => {
        ...
        return (
          <Badge variant="info" className={cn("rounded-md px-3 py-1 text-[10px] font-black tracking-tight border shadow-none", style)}>
            {item.status}
          </Badge>
        );
      }
    ...
    //   key: 'actions',
    //   render: () => (
    //     <button className="p-2 hover:bg-gray-100 rounded-md text-primary-500 transition-colors active:scale-90">
  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
      ...
      <Card className="flex flex-col gap-6  border-none p-0 overflow-hidden bg-white p-6 ">
          ...
          <div className="flex items-center gap-3 flex-1 justify-end max-w-4xl">
            ...
            <div className="relative">
              <Button
                ...
                className={cn(
                  "gap-2 border-gray-100 font-black rounded-md min-w-[110px] h-12 transition-all ",
        ...
        <div className="flex flex-col gap-6  border-none p-0 overflow-hidden bg-transparent">
