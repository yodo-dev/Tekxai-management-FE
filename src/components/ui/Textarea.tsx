    ...
    return (
      <div className={cn('flex flex-col gap-1.5 w-full', containerClassName)}>
        ...
        <div className="relative group">
          <textarea
            className={cn(
              'min-h-[100px] w-full rounded-md border border-gray-200 bg-white px-4 py-3 text-[14px] font-medium text-gray-700 placeholder:text-gray-400 focus-visible:outline-none focus:border-primary-500 focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-gray-300 hover:shadow-sm focus:shadow-[0_0_0_4px_rgba(0,92,218,0.15)] resize-none',
